              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Api.queryAccount(AccountController.text, pwdController.text).then((value) {
                             ...
                             builder: (context){
                               ...
                               return AlertDialog(
                                 ...
                                 content: Align(
                                   ...
                                   child:
                                       Text("登入成功", style: TextStyle(fontSize: 16, color: Colors.white),)
                               ...
                               return AlertDialog(
                                 ...
                                 content: Column(
                                   ...
                                   children: <Widget>[
                                     ...
                                     Text("帳號密碼錯誤", style: TextStyle(fontSize: 20, color: Colors.white),),
                                   ],
                                 ),
                               );
                             }
